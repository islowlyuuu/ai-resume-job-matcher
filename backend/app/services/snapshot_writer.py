    ...
    return "\n".join(
        [
            ...
            *_list_items(analysis.rewritten_bullets),
            ...
            "",
            "### 核心技能",
            *_list_items(analysis.job_core_skills),
            "",
            "### 业务场景",
            *_list_items(analysis.job_business_contexts),
            "",
            "### 加分项",
            *_list_items(analysis.job_bonus_points),
            "",
            "### 硬性要求",
            *_list_items(analysis.job_hard_requirements),
            "",
            "### 已覆盖关键词",
            *_list_items(analysis.covered_keywords),
            "",
            "### 待补充关键词",
            *_list_items(analysis.missing_keywords),
            "",
            "## 匹配优势",
            "",
