          ...
          <div className="min-w-0">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {analysis.ats_keywords.slice(0, 8).map((keyword) => (
                <span
                  key={keyword}
                  className="rounded-md border border-stone-200 bg-[#fbfaf7] px-2.5 py-1 text-xs font-medium text-stone-700"
                >
                  {keyword}
                </span>
              ))}
      ...
      <div className="rounded-lg border border-stone-200 bg-white p-5 shadow-sm">
        ...
        <div className="mt-4 space-y-3">
          {openers.map((opener, index) => (
            <div
              key={opener}
              className="flex gap-3 rounded-md border border-stone-200 bg-[#fbfaf7] p-3"
            >
              <span className="mt-0.5 grid h-6 w-6 shrink-0 place-items-center rounded-md bg-ink text-xs font-semibold text-white">
                {index + 1}
              </span>
