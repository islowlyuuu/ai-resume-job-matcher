          ...
          <div className="min-w-0">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              {analysis.ats_keywords.slice(0, 8).map((keyword) => (
                <span
                  key={keyword}
                  className="rounded-md border border-stone-200 bg-[#f6f4ef] px-2.5 py-1 text-xs font-medium text-stone-700"
                >
                  {keyword}
                </span>
              ))}
            ...
            <div className="rounded-lg border border-stone-200 bg-[#fbfaf7] p-4">
              ...
              <div className="mt-4 flex flex-wrap gap-2">
                {analysis.ats_keywords.map((keyword) => (
                  <span
                    key={keyword}
                    className="rounded-md border border-stone-200 bg-white px-2.5 py-1 text-xs font-medium text-stone-700"
                  >
                    {keyword}
                  </span>
                ))}
